...
export const SponsorColmena = () => {
  const subscriptionTiers = [
    {
      title: 'Single',
      description: 'Patrocinio anual individual que incluye acceso a contenido exclusivo y descuentos en productos.',
      price: '70.00€',
    },
    {
      title: 'Pro',
      description: 'Patrocinio premium con ventajas exclusivas como visitas a colmenares y productos personalizados.',
      price: '110.00€',
    },
  ];
  const galleryImages = [
  ...
  const testimonials = [
    { comment: '¡Gran iniciativa para salvar abejas!', name: 'María G.', rating: '★★★★★' },
    { comment: 'La miel es deliciosa y apoyo una buena causa.', name: 'Juan P.', rating: '★★★★★' },
    { comment: 'Excelente servicio y compromiso.', name: 'Ana R.', rating: '★★★★★' },
  ];
  ...
  return (
    <div className="subscriptions-container">
      <div className="header">
        ...
        <p>Disfruta de miel exclusiva, ayuda a la biodiversidad y vive una experiencia única en el campo</p>
      </div>
